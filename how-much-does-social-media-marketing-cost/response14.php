...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$res['success']) {
        ...
        header("Location: https://viralbreath.com/how-much-does-social-media-marketing-cost/");
    } else {
        // If CAPTCHA is successfully completed...

        // Paste mail function or whatever else you want to happen here!
        header("Location: https://viralbreath.com/social-media-ad-budget-calculator");
    }
} else { ?>
